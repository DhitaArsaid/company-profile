            ...
            <div class="container">
                <div class="row g-5 align-items-center">
                    ...
                    <div class="col-lg-6">
                        ...
                        <p class="mb-4">Legitima is a digital marketing agency that provides services including Digital
                            Strategy Consulting, Social Media Management (SMM), Corporate Video Production, and Digital
                            Advertising.</p>
                        <p class="mb-4">
                            We want businesses to have a more mature and measurable digital marketing strategy with
                            Legitima Indonesia. Supported by the ability of a team from millennials with backgrounds in
                            communication, technology, and management,
                            we are able to generate marketing strategy ideas from different perspectives to encourage
                            your business to grow and meet the targets that your business has set.
                        </p>
        ...
        <div class="container-xxl py-5">
            <div class="container">
                <div class="row g-5 align-items-center">
                    ...
                    <div class="col-lg-6">
                        <h5 class="section-title ff-secondary text-start text-primary fw-normal">About Us</h5>
                        <h1 class="mb-4">Latar Belakang Legitima Indonesia</h1>
                        <p class="mb-4">
                            Mengingat telah terjadi perubahan perilaku manusia dalam bersosialisasi di kehidupan sehari-hari. Dimana perkembangan teknologi memungkinkan pelaku usaha untuk berinteraksi dengan pelanggan maupun penggemar lebih efektif dari sebelumnya serta dapat membantu pelaku usaha untuk mempercepat memenuhi tujuan awal.
                        </p>
                        <p class="mb-4">
                           Didukung dengan kemampuan tim dari kalangan milenial dan memiliki latar belakang di bidang komunikasi, teknologi, dan manajemen kami mampu menghasilkan ide-ide strategi pemasaran dari perspektif yang berbeda untuk mendorong usaha anda dapat berkembang dan memenuhi target-target ysng usaha anda tentukan. 
                        </p>
                        <div class="row g-4 mb-4">
                            <div class="col-sm-6">
                                <div class="d-flex align-items-center border-start border-5 border-primary px-3">
                    ...
                    <div class="col-lg-6">
                        <div class="row g-3">
                            ...
                            <div class="col-6 text-start">
                                <img class="img-fluid rounded w-75 wow zoomIn" data-wow-delay="0.3s"
                                    src="img/12.jpg" style="margin-top: 25%" />
                            </div>
                            <div class="col-6 text-end">
                                <img class="img-fluid rounded w-75 wow zoomIn" data-wow-delay="0.5s"
                                    src="img/11.jpg" />
